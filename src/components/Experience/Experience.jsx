  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-16">
        <h2 className="text-4xl font-bold text-black">POSITION OF RESPONSIBILITY</h2>
        ...
        {responsibilities.map((item) => (
          ...
          >
            ...
            <div className="md:w-3/4">
              ...
              <p className="text-sm text-black mt-1">{item.date}</p>

              {/* Description */}
              <p className="mt-4 text-black">{item.desc}</p>
